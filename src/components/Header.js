  ...
  return (
      <header className="header-main">
        ...
        { matches && <ul className='link-list' onClick={headerClickHandler}>
            <li >Home</li>
            <li data-active={page ==='series' ? true : false} className='link-li'>Series</li>
            <li data-active={page === 'movies' ? true : false} className='link-li'>Movies</li>
            <li data-active={page === 'originals' ? true : false} className='link-li' >Originals</li>
